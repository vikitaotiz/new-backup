                ...
                <div class="panel-body">
                        ...
                        <form action="{{route('charges.update', $charge->id)}}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" value="{{$charge->name}}" class="form-control" placeholder="Enter charge Name...">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Charge Amount</label>
                                            <input type="number" name="amount" value="{{$charge->amount}}" class="form-control" placeholder="Enter charge amount...">
                                        </div>
                                    </div>
                                </div><hr>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" placeholder="Enter charge Description...">
                                        {{$charge->description}}
                                    </textarea>
                                </div> <hr>
                                <div class="form-group">
